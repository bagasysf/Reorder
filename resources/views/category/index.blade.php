...
<div class="row mt-5">
    ...
    <div class="col-5">
        <button class="btn btn-transparent btn-lg shadow ms-2 fw-bold fs-6" style="width: auto; height: 48px;">Add New Category</button>
    </div>
</div>
<div class="row">
    ...
    <div class="col-5 mt-4">
        <form action="/category" method="POST">
            @csrf
            <div class="mb-4 fs-6">
                <input type="text" name="name" class="form-control ps-3 shadow border-0" style="font-size: 14px; width: 100%; height: 48px;" id="exampleFormControlInput1" placeholder="Type name here ..">
            </div>
            <div class="mb-4">
                <textarea name="description" class="form-control ps-3 pt-3 shadow border-0" style="font-size: 14px;" placeholder="Type description here .." id="exampleFormControlTextarea1" rows="3"></textarea>
            </div>
            <div class="d-flex justify-content-end" style="height: 48px;">
                <button type="submit" class="btn btn-secondary rounded fw-bold shadow" style="width: 130px;">Submit</button>
            </div>
        </form>
    </div>
</div>
